        ...
        <div class="sidebar-collapse">
            <ul class="nav" id="side-menu">
                        ...
                        <a data-toggle="dropdown" class="dropdown-toggle" href="#">
								<span class="clear">
									<span class="block m-t-xs" style="font-size: 20px;">
										<strong class="font-bold">&nbsp;荔枝烧蓝莓企业员工管理系统</strong>
									</span>
								</span>
                        </a>
                    </div>
                    <div class="logo-element">EMS</div>
                </li>
                ...
                <li><a href="#">
                    ...
                    <span class="nav-label">考勤管理</span><span class="fa arrow"></span>
                </a>
                    <ul class="nav nav-second-level">
                ...
                <li><a href="#">
                    <i class="fa fa-sitemap"></i>
                    <span class="nav-label">岗位管理</span><span class="fa arrow"></span>
                </a>
                    <ul class="nav nav-second-level">
                        <li><a class="J_menuItem" href="<%=path %>/position/listPage.do?pageNo=1">岗位管理</a>
                        </li>
                    </ul>
                </li>
                ...
                <li>
                    ...
                    <ul class="nav nav-second-level">
                        <li><a class="J_menuItem" href="<%=path %>/attendance/list1.do">考勤统计</a>
...
<%--                </a>--%>
<%--                    <ul class="nav nav-second-level">--%>
<%--                        <li><a class="J_menuItem" href="<%=path %>/gonggao/listPage.do?pageNo=1">公告信息</a>--%>
<%--                        </li>--%>
<%--                    </ul>--%>
<%--                </li>--%>
            </ul>
