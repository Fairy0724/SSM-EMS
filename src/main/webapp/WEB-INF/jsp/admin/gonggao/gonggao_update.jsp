			...
			<div class="col-sm-12">
				<div class="ibox float-e-margins">
					...
					<div class="ibox-content">
						<% Gonggao gonggao = (Gonggao)request.getAttribute("gonggao"); %>
						<form method="post" class="form-horizontal" id="commentForm" action="<%=path %>/gonggao/<%=gonggao.getId() %>/update.do">
							<div class="form-group">
								<label class="col-sm-3 control-label">公告标题</label>
								<div class="col-sm-7">
									<input type="text" class="form-control" placeholder="" name="title" value="<%=gonggao.getTitle() %>" required>
								</div>
							</div>
							<div class="form-group">
								<label class="col-sm-3 control-label">公告内容</label>
								<div class="col-sm-7">
									<input type="text" class="form-control" placeholder="" name="content" value="<%=gonggao.getContent() %>">
								</div>
							</div>
