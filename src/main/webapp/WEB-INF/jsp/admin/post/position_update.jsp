                ...
                <div class="ibox-content">
                    ...
                    <form method="post" class="form-horizontal" id="commentForm"
                        ...
                        <div class="form-group">
                            <label class="col-sm-3 control-label">岗位号</label>
                            <div class="col-sm-7">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-7">
                                ...
                                <%--									</select>--%>
                                <select class="form-control m-b" name="level" size="1" required>
                                    <option value="HR" <%= "HR".equals(position.getLevel()) ? "selected" : "" %>>HR
                                    </option>
                                    <option value="系统管理员" <%= "系统管理员".equals(position.getLevel()) ? "selected" : "" %>>
                                        系统管理员
                                    </option>
                                    <option value="部门主管" <%= "部门主管".equals(position.getLevel()) ? "selected" : "" %>>
                                        部门主管
                                    </option>
                                    <option value="普通员工" <%= "普通员工".equals(position.getLevel()) ? "selected" : "" %>>
                                        普通员工
                                    </option>
                                </select>
                            </div>
