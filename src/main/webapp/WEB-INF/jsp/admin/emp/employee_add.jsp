					...
					<div class="ibox-content">
						<form method="post" class="form-horizontal" id="commentForm" action="<%=path %>/employee/add.do">
							...
							<div class="form-group">
								...
								<div class="col-sm-7">
									<input type="password" class="form-control" placeholder="" id="password" name="password" minlength="3" required>
								</div>
							</div>
							<div class="form-group">
								<label class="col-sm-3 control-label">确认密码</label>
								<div class="col-sm-7">
									<input type="password" class="form-control" placeholder="" name="password2" equalTo="#password" minlength="3" required>
								</div>
							</div>
							<div class="form-group">
