			...
			<div class="col-sm-12">
				<div class="ibox float-e-margins">
					...
					<div class="ibox-content">
						<form method="post" class="form-horizontal" id="commentForm" action="<%=path %>/rewardsPunishment/add.do">
<%--							<div class="form-group">--%>
<%--								<label class="col-sm-3 control-label">奖惩号</label>--%>
<%--								<div class="col-sm-7">--%>
<%--									<% Integer rewardsPunishmentNumber = (Integer)request.getAttribute("rewardsPunishmentNumber"); %>--%>
<%--									<input type="text" class="form-control" name="rewardsPunishmentNumber" value="<%=rewardsPunishmentNumber %>" readonly="readonly">--%>
<%--								</div>--%>
<%--							</div>--%>
							...
							<div class="form-group">
								...
								<div class="col-sm-7">
									<input type="text" class="form-control" placeholder="请输入员工编号" name="employeeNumber" required>
								</div>
							</div>
							<div class="form-group">
...
<%--							</div>--%>
							<div class="form-group">
								<label class="col-sm-3 control-label">管理</label>
								<div class="col-sm-7">
