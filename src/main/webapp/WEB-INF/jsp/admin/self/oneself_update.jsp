					...
					<div class="ibox-content">
						...
						<form method="post" class="form-horizontal" id="commentForm" action="<%=path %>/employee/<%=employee.getId() %>/update.do">
							...
							<div class="form-group">
								...
								<div class="col-sm-7">
									<input type="password" class="form-control" name="password" value="<%=employee.getPassword() %>" minlength="3" required>
								</div>
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								...
								<div class="col-sm-7">
									<select class="form-control m-b" name="status" readonly size="1">
