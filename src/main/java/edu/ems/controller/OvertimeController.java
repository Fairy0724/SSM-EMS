...
import edu.ems.entity.Overtime;
import edu.ems.service.DepartmentService;
import edu.ems.service.EmployeeService;
import edu.ems.service.OvertimeService;
...
public class OvertimeController {
	...
	public String selectListByPgae(Model model, int pageNo){
		...
		return "admin/overtime/overtime_list";
	}
	...
	public String toAdd(Model model){
		...
		return "admin/overtime/overtime_add";
	}
	...
	public String toUpdate(Model model, @PathVariable Integer id){
		...
		List<Employee> eList = employeeService.selectList(new EntityWrapper<Employee>());
		model.addAttribute("eList", eList );
		return "admin/overtime/overtime_update";
	}
	...
	public String select(Model model, @PathVariable Integer employeeNumber, int pageNo){
		...
		model.addAttribute("page",page);
		return "admin/self/oneself_overtime";
	}
